<?php include_once 'header2.php'; ?>
      ...
      <div class="container">
		<div class="row justify-content-center mb-5 pb-3">
          <div class="col-md-7 text-center heading-section ftco-animate">
            ...
            <h2 class=""><span>ASEZE 2025</span> Exhibitors</h2>
          </div>
        </div>
      </div>
    </section>
    ...
    <div class="row d-flex justify-content-center mt-4 mb-4">
        <div class="col-md-8">
          <form action="includes/inc.join-exhibitors.php" class="join-form" method="POST">
              <p>Name of SEZ or Company</p>
              <input id="input11" class="input" type="text" name="company" placeholder="Enter SEZ or Company name" required> 
              
              <p>Organization type</p> 
              <select class="join-form-select input" id="kantry11" style="color: #888888;" name="business" required>
              ...
              <input id="inpt2" class="input" type="text" name="business2" placeholder="Enter other organization type">
              
              <p>Organizations full address</p>
              <input id="input55" class="input" type="text" name="address" placeholder="Enter business full address" required>
              <p>Organizations website</p>
              <input id="input77" class="input" type="text" name="website" placeholder="Enter website url" required>
              <div class="badge" style="margin-bottom: 38px; margin-top: 7px; position: relative;">
                <div class="badgebasket seperatedownwards" style="float: left;">
                  ...
                  <input id="input33" class="badgebaskethalf" style="font-size: 16px;" type="text" name="firstname" placeholder="Passport first name" required>
                </div>
                <div class="badgebasket" style="float: right;">
                  <p style="font-size: 16px; font-weight: normal; margin-bottom: 10px;">Passport last name</p>
                  <input id="input333" class="badgebaskethalf" style="font-size: 16px;" type="text" name="lastname" placeholder="Passport last name" required>
                </div>
              </div>
              <br>
              <p>Designation <span style="font-size: 14px; color: #727272; margin-left: 6px;">(*Your role in organization)</span></p>
              <input id="input3333" class="input" type="text" name="designation" placeholder="Enter designation" class="half" required>
              <p>Applicant's email addresss</p>
              <input id="input44" class="input" type="email" name="email" placeholder="Enter email address" required>
              <p>Country</p>
              <select class="join-form-select input" style="color: #888888;" name="country" id="kantry" onchange="selectionchange()" required>
              ...
              <input id="input66" class="input" type="text" name="phone" placeholder="Enter code & number (+1 2345 6789)" required>
              <p>Preferred Booth Number Choice #1 <span style="color: grey; font-size: 15px;">(can input several adjcent booths)</span></p>
              <input id="input1010" class="input" type="text" name="booth1" placeholder="Preferred booth number" required>
              <p>Preferred Booth Number Choice #2 <span style="color: grey; font-size: 15px;">(can input several adjcent booths)</span></p>
              <input id="input1212" class="input" type="text" name="booth2" placeholder="Preferred booth number" required>
              ...
              <br>
              <p>How did you learn about the expo: <span style="font-size: 14px; color: #727272; margin-left: 6px;">(e.g. Social media, Publication, Return Exhibitor, Referral, Digital Ad?)</span></p>
              <input id="input22" class="input" type="text" name="learn" placeholder="Enter medium" required>
              ...
              <button id="submitexhibitor" type="submit" name="submit" value="Submit" class="submit px-3 sender">Submit</button>
              <p style="font-size: 11px; color: #c0c0c0;">Do not submit passwords through this form.</p>
          </form>
        </div>
    </div>
