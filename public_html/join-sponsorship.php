<?php include_once 'header2.php'; ?>
      ...
      <div class="container">
		<div class="row justify-content-center mb-5 pb-3">
          <div class="col-md-7 text-center heading-section ftco-animate">
            ...
            <h2 class=""><span>ASEZE 2025</span> Sponsorship</h2>
          </div>
        </div>
      </div>
    </section>
    ...
    <div class="row d-flex justify-content-center mt-4 mb-4">
        <div class="col-md-8">
          <form action="includes/inc.join-sponsorship.php" class="join-form" method="POST">
              <p>Select sponsorship type</p>
              <select class="join-form-select input" id="kantry1" style="color: #888888;" name="type" required>
    		      <option value="">Select sponsorship</option>
    		      <option value="Portrait">Portrait Sponsor - SEZ</option>
    		      <option value="Gold">Gold Sponsor - Non SEZ </option>
    		  </select><br>
              <p>Name of SEZ or Company</p>
              <input id="inpt1" class="input" type="text" name="company" placeholder="Enter SEZ or Company name" required> 
              ...
              <input id="inpt3" class="input" type="text" name="address" placeholder="Enter business full address" required>
              <p>Organizations website</p>
              <input id="inpt4" class="input" type="text" name="website" placeholder="Enter website url" required> 
              <div class="badge" style="margin-bottom: 38px; margin-top: 7px; position: relative;">
                <div class="badgebasket seperatedownwards" style="float: left;">
                  ...
                  <input id="inpt5" class="badgebaskethalf" style="font-size: 16px;" type="text" name="firstname" placeholder="Passport first name" required>
                </div>
                <div class="badgebasket" style="float: right;">
                  <p style="font-size: 16px; font-weight: normal; margin-bottom: 10px;">Passport last name</p>
                  <input id="inpt55" class="badgebaskethalf" style="font-size: 16px;" type="text" name="lastname" placeholder="Passport last name" required>
                </div>
              </div>
              <br>
              <p>Designation <span style="font-size: 14px; color: #727272; margin-left: 6px;">(*Your role in organization)</span></p>
              <input id="inpt555" class="input" type="text" name="designation" placeholder="Enter designation" class="half" required>
              <p>Applicant's email addresss</p>
              <input id="inpt6" class="input" type="email" name="email" placeholder="Enter email address" required>
              <p>Country</p>
              ...
              <input id="inpt8" class="input" type="text" name="phone" placeholder="Enter code & number (+1 2345 6789)" required>
              ...
              <input id="inpt9" class="input" type="text" name="learn" placeholder="Enter medium" required>
              ...
              <button id="submitsponsors" type="submit" name="submit" value="Submit" class="submit px-3">Submit</button>
