<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $ins = "INSERT INTO `aseze_sponsorship` (`type`, `company`, `learn`, `first_name`, `last_name`, `designation`, `email`, `country`, `phone`, `website`, `business`, `business_address`, `expectations`, `year`, `read_policy`, `agroprocessing`, `renewable`, `minerals`, `pharmaceuticals`, `manufacturing`, `construction`, `logistics`, `tourism`, `ict`, `financial`, `status`) VALUES ('$type', '$company', '$learn', '$firstname', '$lastname', '$designation', '$email', '$country', '$phone', '$website', '$business', '$address', '$expect', '$year', '$agree', '$agroprocessing', '$renewable', '$minerals', '$pharmaceuticals', '$manufacturing', '$construction', '$logistics', '$tourism', '$ict', '$financial', 'processing')";          
        ...
        $message = (new Swift_Message('ASEZE Sponsorship'))
          ...
          ->setBody('<div style="border: 1px solid #cccccc; height: auto; width: 80%; padding: 20px; border-radius: 5px;">
                        ...
                        <br>
                        <p>Dear '.$firstname.'</p>
                        <p>Thank you for submitting your application for ASEZE 2025 <b>'.$type.'</b> sponsorship category.</p>
                        <p>Your application is being processed and one of our team members will contact you shortly with information on how to complete the sponsorship application.</p>
                        <p>If you have a query, please reach out to us by replying to this email.</p>
        ...
        header("Location: https://aseze.africa/portrait-gold?spr=sucs"); 
        exit();
